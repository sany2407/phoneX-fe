...
const B: DeviceType[] = ["phone", "laptop"];
...
export const SKINS: Skin[] = [
  ...
  s("Sensei Mode", "anime", "textured", "frosted", 479, ["#93c5fd", "#1e1b4b"], "rays", P, { popularity: 78 }),
  // Gaming
  s("Headshot", "gaming", "matte", "satin", 499, ["#22d3ee", "#7c3aed"], "neon-grid", B, { rating: 4.6, reviews: 411, popularity: 94, featured: true }),
  s("Respawn", "gaming", "carbon-fiber", "satin", 649, ["#10b981", "#0f172a"], "circuit", P, { popularity: 85 }),
  s("Clutch Frame", "gaming", "textured", "satin", 459, ["#f43f5e", "#111114"], "stripes", P, { discountPct: 15, popularity: 72 }),
  // Cyberpunk
  s("Night City Pulse", "cyberpunk", "glossy", "gloss", 599, ["#f0abfc", "#0ea5e9"], "circuit", B, { rating: 4.9, reviews: 502, popularity: 98, featured: true }),
  s("Chrome Ghost", "cyberpunk", "glossy", "metallic", 699, ["#94a3b8", "#0f172a"], "topo", P, { isNew: true, popularity: 88 }),
  s("Edgerunner 2077", "cyberpunk", "matte", "satin", 549, ["#facc15", "#111114"], "neon-grid", P, { popularity: 82 }),
  // Cars
  s("Apex GT", "cars", "carbon-fiber", "satin", 699, ["#ef4444", "#18181b"], "stripes", B, { rating: 4.8, reviews: 377, popularity: 93, featured: true }),
  s("Nürburgring", "cars", "matte", "satin", 529, ["#e5e7eb", "#171717"], "topo", P, { popularity: 80 }),
  ...
  s("Off White", "minimal", "transparent", "frosted", 449, ["#ffffff", "#e4e4e7"], "solid", P, { reviews: 430, popularity: 89 }),
  ...
  s("Soft Machine", "abstract", "textured", "frosted", 489, ["#a5b4fc", "#f0abfc"], "gradient", P, { isNew: true }),
  // Nature
  ...
  s("Monsoon Greens", "nature", "textured", "satin", 459, ["#4ade80", "#14532d"], "blobs", P, { discountPct: 10 }),
  // Marble
  s("Carrara Nero", "marble", "glossy", "gloss", 599, ["#f5f5f4", "#1c1917"], "marble", B, { rating: 4.8, reviews: 289, popularity: 92, featured: true }),
  s("Rosso Vein", "marble", "matte", "satin", 569, ["#fecaca", "#7f1d1d"], "marble", P, { isNew: true, popularity: 83 }),
  ...
  s("Lunar Surface", "space", "textured", "frosted", 529, ["#d4d4d8", "#52525b"], "topo", P, { popularity: 79 }),
  ...
  s("Loud Type", "typography", "glossy", "gloss", 439, ["#fde047", "#111114"], "stripes", P, { discountPct: 12 }),
  // Music
  s("Bassline", "music", "matte", "satin", 479, ["#f59e0b", "#18181b"], "waves", B, { rating: 4.5, reviews: 176, popularity: 73 }),
  s("Vinyl Hours", "music", "textured", "satin", 499, ["#fca5a5", "#450a0a"], "checker", P, { popularity: 68 }),
  // Sports
  s("Court Vision", "sports", "matte", "satin", 469, ["#fb923c", "#1d4ed8"], "rays", P, { rating: 4.4, reviews: 143, popularity: 66 }),
  ...
  s("Gouache Garden", "art", "textured", "frosted", 509, ["#f9a8d4", "#a3e635"], "petals", P, { popularity: 71 }),
  ...
  s("Cassette Gold", "retro", "matte", "satin", 469, ["#fbbf24", "#78350f"], "stripes", P, { popularity: 69 }),
  // Dark
  ...
  s("Mochi Gang", "cute", "matte", "satin", 449, ["#fbcfe8", "#ddd6fe"], "blobs", P, { isNew: true, popularity: 80 }),
